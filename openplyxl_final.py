...
# # 해당이름의 csv파일을 읽어옴
r_csv = pd.read_csv("C:/Users/codka/OneDrive/바탕 화면/data/feeds.csv")
...
wb = load_workbook("C:/Users/codka/OneDrive/바탕 화면/data/원예작물재배및실습_11주차_4조_형식자료.xlsx")
ws = wb.active
# print(ws.max_row)
...
wb.save('C:/Users/codka/OneDrive/바탕 화면/data/원예작물재배및실습_{}주차_4조_final.xlsx'.format(week))
